...
type AddNewMenuItemPageContentProps = {
    handleAddNewMenuItem: () => void,
    itemName:string,
...
function AddNewMenuItemPageContent({
...
}:AddNewMenuItemPageContentProps) {
    ...
    return (
        <PageContent>
            ...
            <div className='w-full flex justify-center'>
                <button onClick={()=> isInputsValid && handleAddNewMenuItem()} disabled={!isInputsValid} className='w-[350px] text-primary duration-300 hover:bg-primary hover:text-smokey-white font-semibold text-2xl capitalize rounded-2xl h-[60px] border border-primary'>
                    add item
                </button>
            </div>
        </PageContent>
...
export default AddNewMenuItemPageContent