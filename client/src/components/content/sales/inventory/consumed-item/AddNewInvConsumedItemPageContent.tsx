...
type AddNewInvConsumedItemPageContentProps = {
...
function AddNewInvConsumedItemPageContent({
...
}:AddNewInvConsumedItemPageContentProps) {
    return (
        <PageContent>
...
export default AddNewInvConsumedItemPageContent