...
type EditMedicalMedicinePageContentProps = {
    itemName: string,
    ...
    handleUpdateMedicalMedicine: () => void,
    isInputsValid: boolean,
    dosage:string,
    setDosage: (newState:string) => void,
}
function EditMedicalMedicinePageContent({
  itemName,
  setItemName,
  quantity,
  setQuantity,
  ...
  type,
  setType,
  handleUpdateMedicalMedicine,
  isInputsValid,
  dosage,
  setDosage,
}:EditMedicalMedicinePageContentProps) {
    return (
        <PageContent>
            ...
            <div className='w-full flex justify-center'>
                <button onClick={()=> isInputsValid && handleUpdateMedicalMedicine()} disabled={!isInputsValid} className='w-[350px] text-primary duration-300 hover:bg-primary hover:text-smokey-white font-semibold text-2xl capitalize rounded-2xl h-[60px] border border-primary'>
                    save item
                </button>
            </div>
        </PageContent>
...
export default EditMedicalMedicinePageContent