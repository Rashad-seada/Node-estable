...
type AddNewInvItemPageContentProps = {
    handleAddNewInventoryItem: () => void,
    itemName:string,
...
function AddNewInvItemPageContent({
    ...
    return (
        <PageContent>
            ...
            <div className='w-full flex justify-center'>
                <button onClick={()=> isInputsValid && handleAddNewInventoryItem()} disabled={!isInputsValid} className='w-[350px] text-primary duration-300 hover:bg-primary hover:text-smokey-white font-semibold text-2xl capitalize rounded-2xl h-[60px] border border-primary'>
                    add item
                </button>
            </div>
        </PageContent>
...
export default AddNewInvItemPageContent